          ...
          <div className="row">
            ...
            <div className="col-sm-10 d-flex align-items-center part2">
              ...
              <div className="part3 d-flex align-items-center ml-auto">
                {
                  contries.isLogin !== true ? <Link to="/signin" className="border-effect"><Button className="btn-2bbef9 btn-lg btn-big text-white mr-3">Sign In</Button></Link> : <Button className="circle mr-3 btn-2bbef9 text-white">
                    <FiUser />
                  </Button>
                }
